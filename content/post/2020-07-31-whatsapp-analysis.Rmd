...
بالإضافة إلى ذلك,الأمر الذي دفعني لإختيار بيانات برنامج الواتس هو جاهزية استخراج بيانات المحادثات من أي مجموعة بسهولة. الأمر الآخر هو ان لا استخدم البرامج الأخرى (الإنستقرام, السنابشات,...) بكثافة وبالتالي لن يكون هناك كمية بيانات وافرة للتحليل. 
...
1- هل هناك اختلاف مستوى نشاط مجموعة اصدقاء (الدفعة 2005-2006) خلال الفترة الحالية مقارنة بالاوقات السابقة. 
...
بالإمكان استخراج تاريخ المحادثات لأي مجموعة عن طريق الخطوات التالية 

1- اختر المجموعة التي تريد ثم اضغط على اسم المجموعة في الأعلى 
...
عندما بدأت العمل على هذه التدوينة كنت بصدد كتابة كود (من الصفر) يقوم بقراءة كل رسالة واستخراج اسم المرسل والتاريخ وكذلك النص نفسه. لكن ثقتي بمجتمع لغة R دفعتني إلى البحث اولا عن حزمة تقوم بذلك عوضا عن إعادة اختراع العجلة كما يقولون. انا سعيد بأن اخبرك أن مجتمع R لم يخيب ظني.

لقد وجدت هذه الحزمة `rwhatsapp` والتي لا تقوم بإستخراج المعلومات التي كنت اريدها فحسب بل ايضا تستخرج الأيموجيز من كل رسالة. هذا الأمر سهل علي الإجابة على السؤال الثالث. 
...
*ملاحظة* : في الخطوات القادمة سوف اقوم ببعض العمليات على البيانات للحفاظ على خصوصية الأعضاء
...
في البيانات اعلاه نجد أن لدينا 5 متغيرات و 171 ألف رسالة. تعود هذه البيانات إلى اكثر من اربع سنوات تقريبا. نلاحظ ايضا ان هناك اكثر من 113 عضو خلال تلك نالفترة. هذا بالطبع لا يعني ان هذا العدد نفس عدد الأعضاء الحالي.
...
الرسم البياني اعلاه يوضح اكثر الأعضاء نشاطا من حيث عدد الرسائل. يبدو ان رقم 099 هو اكثر الأعضاء سوالف فالفارق كبير بينه وبين المركز الثاني. إذا كانت المشاركات بهذا الشكل فهذا يبين أن لعله من الأفضل انشاء مجموعة منفصلة للأعضاء المعلمين بالأحمر. 

من جانب آخر, نجد ان بعض الاعضاء اقل نشاطا لكنهم اطول محتوى. الأعمدة الرمادية تشير إلى مقارنة المتوسط الحسابي لعدد الأحرف في الرسالة الواحدة لكل من الأعضاء.  بشكل عام الأعضاء الأكثر نشاط عادة ما تكون رسائلهم اقصر محتوى. 


####  هل بالإمكان معرفة جدول الأعضاء اليومي من خلال رسائلهم على الواتس؟

طرأ على بالي هذه السؤال خلال عملية التحليل . السبب هو أنني اعتقد أن معظم الأعضاء يستخدمون برنامج الواتس على مدار اليوم ماعدا النوم. لنرى إن كنت محقاً
...
الرسم البيانات اعلاه يؤكد ما كنت اتوقعه حيث أن مجموعة الأعضاء الأكثر نشاطُا عادة ما يكونو نشطين خلال اليوم بأكمله. النمط بصفة عامة : يبدأ نشاط الأعضاء من الصباح (وقت الدوام) ويزداد حتى ذروته مع فترة استراحة الغداء ثم يستمر حتى وقت العشاء. الملفت أن العضو رقم 106 يمتنع بالغالب من استخدام الواتس خلال اوقات الدوام ولكنه يعوض غيابه بعد نهاية الدوام.
...
من الطرق المستخدمة في تحليل النصوص هو استخدام الـ tf-idf . هذه الطريقة الشائعة تساعد على استخراج المفردات التي تميز مستند من غيره. في هذا المثال, سوف نحاول تمييز مفردات الأعضاء من غيرهم. 
...
خاصية مشاركة المكان على برنامج الواتس هي احد اهم واكثر الخصائص التي استخدمها بشكل يومي. لذلك اجده من الشيق أن اتمكن من تمثيل كل ما تم مشاركته خلال الأربع سنوات الماضية في هذه المجموعة. بعد الإطلاع على عينة من المحادثات اكتشفت ان استخراجها لن يكون عملية سهلة فالأماكن المتشاركة في الواتس تنقسم إلى نوعين .  

- النوع الأول : يكون فيها نص الرسالة متضمن الأحداثيات

- النوع الثاني: يكون فيها نص الرسالة متضمن لرابط مختصر لخرائط جوجل

النوع الأول سهل جدا استخراج الأحداثيات عن طريق استخدام Regular Expression . لكن النوع الثاني سوف يتطلب منا أن نمدد الرابط اولا ثم يقوم موقع خرائط جوجل بمعالجته وتزويد الأحداثيات في الرابط الجديد. لا تقلق هناك حيلة بإمكاننا استخدامها لفعل ذلك عن طريق تلقائية عملية التصفح وإرسال الروابط وتمديدها ومعالجتها. سوف يستغرق الأمر لكنه يستحق العناء. 
...
هنا نقوم بتصف الروابط وتمديدها حتى نستخرج الإحداثيات
...
لنقم الآن بتصوير تلك الاحداثيات. اود ان انبه انني سوف اقوم بدمج تلك الأحداثيات بشكل يحافظ على خصوصية الأعضاء كذلك. 
...
هدفي من هذه التدوينة هو تسليط الضوء على كمية البيانات التي نصنعها بشكل يومي دون ان نشعر. لقد تطرقنا هنا لبيانات برنامج واحد ومجموعة واحدة وبرغم من ذلك استطعنا التعرف عن كثب عن الجدول اليومي للأعضاء والمواضيع التي يتحدثون عنها كذلك الأماكن المفضلة لهم. هذا الأمر يدعو فعلا للتأمل حول ما نقوم بمشاركته ونشره على منصات التواصل الأجتماعي. 
